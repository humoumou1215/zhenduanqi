...
const categoryDefinitions = [
  ...
  },
  {
    ...
    name: '类加载',
    description: 'ClassNotFoundException、NoSuchMethodError',
    color: '#909399',
    icon: Search,
  },
];
